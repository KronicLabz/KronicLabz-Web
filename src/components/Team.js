...
const data = [
  { name: 'Dustin Turska', role: 'Founder and CEO', img: portrait1 },
  { name: 'Lance', role: 'Chief Financial Officer', img: portrait2 },
  { name: 'Penny', role: 'Chief Communications Officer', img: portrait3 },
  { name: 'Aiden Rich', role: 'Chief Technology Officer', img: portrait4 },
  { name: 'Fuego Blanco', role: 'Lead Developer', img: portrait5 },
  { name: 'Matt Kristoff', role: 'Project OutReach', img: portrait6 }
]
...
const Team = () =>
  <TeamWrapper>
    <Header>
      <center>
        <h1>Meet the KronicLabz Family</h1>
      </center>
    </Header>
    <Grid>
    {
